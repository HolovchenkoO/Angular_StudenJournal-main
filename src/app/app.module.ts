...
import {StudentJournalModule} from "./components/studensJournal/studentJournal.module";
...
@NgModule({
  ...
  providers: [LocalStorageService, StudentAuthGuard, AdminAuthGuard, AuthService, StudentJournalService],
